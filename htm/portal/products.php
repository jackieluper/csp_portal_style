...
<nav class="menu">
    ...
    <ul>
        <?php if ($_SESSION['role'] >= $userRole) { ?>
            ...
            <li><img class='icon' src='../img/icons/software.png' alt='Manage Subscription'><a href="../portal/manageSubscription.php" onclick="onClick(callback)">Manage Subscriptions</a><br></li>
