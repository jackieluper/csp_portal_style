...
<body>
    ...
    <nav class="menu" ng-app="">
        <a href="#" class="nav-toggle-btn">Menu</a>
        <ul>
            <li ng-if="<?php echo $_SESSION['role'] >= $userRole ?>"><img class='icon' src='../img/icons/software.png' alt='Products' ><a href='../portal/products.php'>Products</a><br></li>
            <li ng-if="<?php echo $_SESSION['role'] >= $userRole ?>"><img class='icon' src='../img/icons/subscriptions.png' alt='Manage Subscription'><a href="../portal/manageSubscription.php">Manage Licenses</a><br></li>
            <li ng-if="<?php echo $_SESSION['role'] >= $userRole ?>"><img class='icon' src='../img/icons/invoice.jpg' alt='Invoice'><a href='../portal/invoice.php'>Invoice</a><br></li>
            <li ng-if="<?php echo $_SESSION['role'] >= $userRole ?>"><img class='icon' src='../img/icons/checkout.png' alt='Checkout' ><a href='../portal/checkout.php'>Checkout</a><br></li>
            <li ng-if="<?php echo $_SESSION['role'] >= $userRole ?>"><img class='icon' src='../img/icons/home.png' alt='Home' ><a href='<?php echo $homePage ?>'><?php echo $companyName ?></a><br></li>
            <li ng-show="<?php echo $_SESSION['role'] == $adminRole ?>"><img class='icon' src='../img/icons/Admin.png' alt='Admin' ><a href='../portal/admin.php'>Administration</a><br></li>
