    ...
    <html>
      ...
      <h4> Billing Details</h4>
        ...
        <form action="" method="post">
          <table>
          <tr><td>Company</td><td><input type="text" name="billing-address-company" value=""></td></tr>
          <tr><td>First Name </td><td><input type="text" name="billing-address-first-name" value=""></td></tr>
          <tr><td>Last Name </td><td><input type="text" name="billing-address-last-name" value=""></td></tr>
          <tr><td>Address </td><td><input type="text" name="billing-address-address1" value=""></td></tr>
          <tr><td>Address 2 </td><td><input type="text" name="billing-address-address2" value=""></td></tr>
          <tr><td>City </td><td><input type="text" name="billing-address-city" value=""></td></tr>
          <tr><td>State/Province </td><td><input type="text" name="billing-address-state" value=""></td></tr>
          <tr><td>Zip/Postal </td><td><input type="text" name="billing-address-zip" value=""></td></tr>
          <tr><td>Country </td><td><input type="text" name="billing-address-country" value="US"></td></tr>
          <tr><td>Phone Number </td><td><input type="text" name="billing-address-phone" value=""></td></tr>
          <tr><td>Fax Number </td><td><input type="text" name="billing-address-fax" value=""></td></tr>
          <tr><td>Email Address </td><td><input type="text" name="billing-address-email" value=""></td></tr>
