        ...
        <div style="margin: 50px 0 0 100px; display: inline-block">
            ...
            <table class="subscriptionDetails" style="width: 60%; float: right">
                ...
                <form action="../controllers/add-to-cart.php" method="post">
                    ...
                    <tr>
                        <td class="subscriptionInfo" colspan="3" style="text-align: center"><input type="hidden" name="id" value="<?php echo $id ?>"><strong>Quantity: </strong><input step="1" name="qty" value="1" style="border-style: groove; border-radius: 5px; width: 20%; text-align: center;"></input></td>
                    </tr>
                    <tr>
