                ...
                <table class="subscriptionDetails">
                    ...
                    <form action="../controllers/update-qty.php" method="post">
                        ...
                        <tr>
                            ...
                            <td class="subscriptionInfo"><input type="number" step="1" name="qty" value="<?php echo $subscriptionList[$i]->getQuantity() + $updateQty ?>" style="border-style: groove; border-radius: 5px; width: 20%;"></input></td>
