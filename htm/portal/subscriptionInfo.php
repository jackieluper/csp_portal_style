            ...
            <div style="float:right">
                <table class="subscriptionDetails">
                    ...
                    <form action="../controllers/update-qty.php" method="post">
                        ...
                        <tr>
                            <td class="subscriptionTitle">Input total licenses you wish to have: </td>
                            <td class="subscriptionInfo"><input step="1" name="qty" value="<?php echo $subscriptionList[$i]->getQuantity() ?>" style="border-style: groove; border-radius: 5px; width: 10%;"></input></td>
