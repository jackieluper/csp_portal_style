    ...
    <div class="contentCheckout">
        ...
        <table class="ui-widget ui-widget-content" id='checkoutTable'>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="5" style="border: none; border-collapse: collapse; background-color: #fff; align: right"><a href="billing.php"><button type="button" class="checkoutButton">Checkout</button></a></td>
                </tr>
            </tbody>
        </table>
    </div>
