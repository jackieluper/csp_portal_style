...
<div class="ss-stand-alone">
    <div class="ss-nav">
        ...
        <div class="fullwidthtitle">
            <h1 class="content-title" id="contentTxt">Successful Registration</h1>
        </div>
</div>
<div class="container">
    <div class="page-header">
        <h2>Success <small>You are now being redirected to our login page. Thank You!</small></h2>
        <p>You will be redirected in <span id="countdown"><strong>5</strong></span>
    </div>
</div>
