            ...
            <table class="subscriptionDetails">
                ...
                <form action="updateQty.php" method="post">
                    <tr>
                        ...
                        <td class="subscriptionInfo"><input step="1" value="<?php echo $subscriptionList[$i]->getQuantity() ?>" style="border-style: groove; border-radius: 5px; width: 30%; align-text: center"></input></td>
